...
public class UpdateIRCommand extends Command {
    public UpdateIRCommand(IDatabase receiver, String[] args, Environment env) {
    ...
    public Object execute() {
        ...
        try {
            ...
            PreparedStatement stmt = con.prepareStatement("call insert_IR(?,?,?,?,?,?)");
